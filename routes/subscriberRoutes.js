...
router.post('/subscribe', async (req, res) => {
  try {
    ...
    // This triggers the 'pre-save' hook in your Model to generate the token
    const subscriber = new Subscriber({ email });
    await subscriber.save();

    // Generate the professional Unsubscribe URL
    // We use the token generated by your mongoose pre-save hook
    const unsubscribeUrl = `${process.env.BASE_URL}/api/unsubscribe/${subscriber.unsubscribeToken}`;
